...
@ECHO                  console - run and wait on xdesktop-console.exe
...
@ECHO                  viewer - run xdesktop-gcodeviewer.exe (no wait)
@ECHO                  window - run XDesktop.exe (no wait)
@ECHO                Default: none
...
IF "%PS_RUN%" EQU "console" (
    icacls xdesktop-console.exe >nul || GOTO :END
    start /wait /b xdesktop-console.exe
) ELSE IF "%PS_RUN%" EQU "window" (
    icacls XDesktop.exe >nul || GOTO :END
    start XDesktop.exe
) ELSE IF "%PS_RUN%" EQU "viewer" (
    icacls xdesktop-gcodeviewer.exe >nul || GOTO :END
    start xdesktop-gcodeviewer.exe
