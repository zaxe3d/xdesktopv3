    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = wxBitmap(from_u8(Slic3r::var("XDesktop_192px.png")), wxBITMAP_TYPE_PNG);
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER)
{
    ...
    // version
    {
        auto version_string = _L("Version") + " " + std::string(XDESKTOP_VERSION);
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_AUTO/*NEVER*/);
    {
        ...
        const std::string based_on_str = _utf8(L("XDesktop is based on Slic3r by Alessandro Ranellucci and the RepRap community."));
...
{
    wxTheClipboard->Open();
    wxTheClipboard->SetData(new wxTextDataObject(_L("Version") + " " + std::string(XDESKTOP_VERSION)));
