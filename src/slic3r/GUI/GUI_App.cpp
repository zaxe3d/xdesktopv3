...
//     Slic3r::debugf "wxWidgets version %s, Wx version %s\n", wxVERSION_STRING, wxVERSION;
    ...
    if (app_config->get("show_splash_screen") == "1") {
        ...
        scrn = new SplashScreen(bmp.IsOk() ? bmp : create_scaled_bitmap("XDesktop", nullptr, bmp.GetWidth()),
...
void GUI_App::associate_3mf_files()
{
    ...
    std::wstring prog_desc = L"XDesktop";
...
void GUI_App::associate_gcode_files()
{
    ...
    std::wstring prog_path = L"\"" + std::wstring(app_path) + L"\"";
    std::wstring prog_id = L"XDesktop.GCodeViewer.1";
    std::wstring prog_desc = L"XDesktopGCodeViewer";
    std::wstring prog_command = prog_path + L" \"%1\"";
    std::wstring reg_base = L"Software\\Classes";
