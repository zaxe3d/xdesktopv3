...
-(void)add_observer:(NSString *)version_hash
{
	...
	//NSString *nsver = @"OtherXDesktopInstanceMessage" + version_hash;
...
void send_message_mac(const std::string &msg, const std::string &version)
{
	...
	//NSString *nsver = @"OtherXDesktopInstanceMessage" + [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
