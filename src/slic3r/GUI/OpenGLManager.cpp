...
#if ENABLE_OPENGL_ES
                _L("XDesktop requires OpenGL ES 2.0 capable graphics driver to run correctly, \n"
...
#elif ENABLE_GL_CORE_PROFILE
                _L("XDesktop requires OpenGL %s capable graphics driver to run correctly, \n"
...
#else
                _L("XDesktop requires OpenGL 2.0 capable graphics driver to run correctly, \n"
                    "while OpenGL version %s, render %s, vendor %s was detected."), s_gl_info.get_version_string(), s_gl_info.get_renderer(), s_gl_info.get_vendor());
#endif // ENABLE_OPENGL_ES
            message += "\n";
