...
void PreferencesDialog::build()
{
	...
	if (is_editor) {
		...
		append_bool_option(m_optgroup_general, "associate_3mf",
			L("Associate .3mf files to XDesktop"),
			L("If enabled, sets XDesktop as default application to open .3mf files."),
			app_config->get_bool("associate_3mf"));

		append_bool_option(m_optgroup_general, "associate_stl",
			L("Associate .stl files to XDesktop"),
			L("If enabled, sets XDesktop as default application to open .stl files."),
...
#if __APPLE__
			L("Allow just a single XDesktop instance"),
...
#else
			L("Allow just a single XDesktop instance"),
			L("If this is enabled, when starting XDesktop and another instance of the same XDesktop is already running, that instance will be reactivated instead."),
#endif
		...
		append_bool_option(m_optgroup_general, "associate_gcode",
			L("Associate .gcode files to XDesktop G-code Viewer"),
			L("If enabled, sets XDesktop G-code Viewer as default application to open .gcode files."),
			app_config->get_bool("associate_gcode"));
		append_bool_option(m_optgroup_general, "associate_bgcode",
			L("Associate .bgcode files to XDesktop G-code Viewer"),
			L("If enabled, sets XDesktop G-code Viewer as default application to open .bgcode files."),
	...
	append_bool_option(m_optgroup_general, "restore_win_position",
		...
		L("If enabled, XDesktop will be open at the position it was closed"),
...
/*
		append_bool_option(m_optgroup_gui, "suppress_hyperlinks",
			...
			L("If enabled, XDesktop will not open a hyperlinks in your browser."),
...
*/
	...
	if (is_editor) {
		...
		append_bool_option(m_optgroup_other, "downloader_url_registered",
			...
			L("If enabled, XDesktop will be allowed to download from Printables.com"),
